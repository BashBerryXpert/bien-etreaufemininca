...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "fwentx-3n.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "dda0a67ac5cd405ef77eaabcab8e6a5c";
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify : abonnement requis", {
      description: "Veuillez activer un plan payant sur admin.shopify.com.",
    });
    return;
  }
